...
//
//                     int const dist = static_cast<int>( std::distance( first, last ) );
//
//                     if ( dist != dist2 )
//                     {
//                         printf(
...
//                     std::advance( last, dist2 );
//
//                     if ( int const dist = static_cast<int>( std::distance( first, last ) ); dist != dist2 - dist1 )
//                     {
//                         printf(
...
//
//
//             auto next_iterator = std::next( p_hive.begin( ), 5 );
//             auto prev_iterator = std::prev( p_hive.cend( ), 300 );
//
...
//
//             auto prev_iterator2 = std::prev( p_hive.end( ), 300 );
...
//
//             auto r_iterator2 = std::next( r_iterator, 2 );
//
...
//             total    = 0;
//
//             for ( auto the_iterator = p_hive.begin( ); the_iterator < p_hive.end( ); std::advance( the_iterator, 2 ) )
//             {
//                 ++total;
//                 numtotal += **the_iterator;
//             }
...
//             total = 0;
//
//             for ( auto the_iterator = --( hive<int*>::iterator( p_hive.end( ) ) ); the_iterator != p_hive.begin( ); std::advance(
//                       the_iterator, -2 ) )
//             {
//                 ++total;
//             }
